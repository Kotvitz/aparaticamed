import { Ear, Check, Headphones, HeartPlus } from "lucide-react";

const ICONS = [Ear, Check, Headphones, HeartPlus];

type HearingAidFittingProcessProps = {
  data: {
    title: string;
    description: string;
    items: {
