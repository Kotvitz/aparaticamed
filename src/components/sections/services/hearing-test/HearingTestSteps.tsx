...
const ICONS = [ClipboardList, Search, AudioLines, MessageSquareText];

type HearingTestStepsProps = {
  data: {
    title: string;
    description: string;
    items: {
...
export default function HearingTestSteps({ data }: HearingTestStepsProps) {
  return (
    <section
