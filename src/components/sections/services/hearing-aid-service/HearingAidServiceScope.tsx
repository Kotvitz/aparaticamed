import { Settings2, Wrench, RefreshCcw, Stethoscope } from "lucide-react";

const ICONS = [Settings2, Wrench, RefreshCcw, Stethoscope];

type HearingAidServiceScopeProps = {
  data: {
    title: string;
    paragraph1: string;
    paragraph2: string;
